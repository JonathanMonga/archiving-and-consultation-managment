...
<div class="row">
  ...
  <div class="large-10 push-3 columns">
	  <h1>Numéros des listes</h1>
	  <p>Depuis cette interface vous pouvez gérer les numéros des listes.</p>
  </div>
	  ...
	  <table>
		  <thead>
			  <tr>
				  ...
				  <th style="background:rgb(103, 58, 183);color:white">Année d'utilisation</th>
				  <th style="background:rgb(103, 58, 183);color:white">Status</th>
			  </tr>
		  </thead>
...
<div class="row">
	  ...
	  <div class="large-4 columns">
		  <input id="id_med_field" name="annee" style="" type="text" placeholder="Année d'utilisation">
	  </div>
	  <div class="large-4 columns">
		  <select id="id_fournisseur" name="state">
...
$(document).ready(function(){
	...
	$('#ajax-load-list-med').hide().load('ajax/afficher-numeros.php').fadeIn();
	...
	$('#add-to-db').on('submit', function() {
		$.ajax({
		  ...
		  success:function(data){
			  ...
			  $('#ajax-load-list-med').fadeOut().load('ajax/afficher-numeros.php').fadeIn();
		  	}
		});
